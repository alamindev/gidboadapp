...
@section('title') Edit Manual Capacity
@endsection
...
<section class="content home">
  ...
  @include('_includes/breadcrumb')
    ...
    <div class="heading">
      <h3 class="font-bold col-teal">Edit Manual Capacity</h3>
    ...
    <!--end user heading -->
    <form action="{{ route('manuals.update',$edit->id) }}" method="post" enctype="multipart/form-data">
      @csrf @method('PUT')
          ...
          <div class="card m-t-30">
            <div class="card-body p-2">
              <div class="form-group {{ $errors->has('national_demand') ? 'is-invalid' : '' }}">
                ...
                <input type="text" class="form-control" name="national_demand" value="{{ $edit->national_demand }}" id="national_demand">
              ...
              <div class="form-group {{ $errors->has('available_capacity') ? 'is-invalid' : '' }}">
                ...
                <input type="text" class="form-control" name="available_capacity" value="{{ $edit->available_capacity }}" id="available_capacity">
              ...
              <div class="form-group {{ $errors->has('transmission_capacity') ? 'is-invalid' : '' }}">
                ...
                <input type="text" class="form-control" name="transmission_capacity" value="{{ $edit->transmission_capacity }}" id="transmission_capacity">
