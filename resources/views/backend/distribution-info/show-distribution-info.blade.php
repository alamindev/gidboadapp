...
@section('title') View distribution Information
@endsection
...
<section class="content home">
  ...
  @include('_includes/breadcrumb')
    ...
    <div class="heading">
      ...
      <a href="{{ route('distributions-info.index') }}" class="btn  btn-raised bg-light-green waves-effect text-white button-item"> <i class="material-icons">add_to_queue</i> &nbsp; <span  class="font-bold text-capitalize">Back</span></a>
    </div>
    <!--end user heading -->
            ...
            <table class="table table-bordered  table-striped">
              <thead>
                <tr>
                  ...
                  <td> :</td>
                  <td>
                    {{ $show->distributions->name }}
                  </td>
                </tr>
                <tr>
                  <th>istributions Information</th>
                  <td> :</td>
                  <td>{!!  $show->info  !!}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <img src="{{ asset('uploads/distributions_info/'.$show->logo) }}" alt="logo" class="img-fluid"> @endif
                  </td>
                </tr>
                @empty(!$show->address)
                <tr>
