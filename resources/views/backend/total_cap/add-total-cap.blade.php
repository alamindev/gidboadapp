...
@section('title') add Total Capacity info
@endsection
...
<section class="content home">
  ...
  @include('_includes/breadcrumb')
    ...
    <div class="heading">
      <h3 class="font-bold col-teal">Add Total Capacity information</h3>
    </div>
    <!--end user heading -->
    <form action="{{ route('total-capacity.store') }}" method="post">
      @csrf
          ...
          <div class="card m-t-30">
            <div class="card-body p-2">
              <div class="form-group {{ $errors->has('info_pie') ? 'is-invalid' : '' }}">
                ...
                <textarea name="info_pie" id="info_pie" cols="30" rows="10" placeholder="write info for this chart"></textarea>
              ...
              <div class="form-group {{ $errors->has('supply_mix') ? 'is-invalid' : '' }}">
                ...
                <textarea name="supply_mix" id="supply_mix" cols="30" rows="10" placeholder="write info for Supply mix"></textarea>
