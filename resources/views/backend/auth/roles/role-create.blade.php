...
<section class="content home">
  ...
  @include('_includes/breadcrumb')
    ...
    <div class="heading">
      <h3 class="font-bold col-teal">Add New Role</h3>
...
<!-- for error showing with sweet alert -->
@if($errors->has('per_table'))
<script>
  swal('Oops...','{{ $errors->first('per_table') }}','error');

</script>
@endif
<!-- End for error showing with sweet alert -->
