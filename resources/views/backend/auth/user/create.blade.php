...
<section class="content home">
  ...
  @include('_includes/breadcrumb')
    ...
    <div class="heading">
      <h3 class="font-bold col-teal">Add New User</h3>
          ...
          <div class="card m-t-30">
            <div class="body">
              <div class="form-group">
                ...
                <input type="text" name="first_name" id="first_name" class="form-control" placeholder="Write your first name" value="{{ old('first_name') }}">
              </div>
              <div class="form-group">
                <label for="last_name">Last Name <span class="text-danger">(Optional)</span></label>
                <input type="text" name="last_name" id="last_name" class="form-control" placeholder="Write your last name" value="{{ old('last_name') }}">
              </div>
              <div class="form-group {{ $errors->has('user_name') ? 'is-invalid' : '' }}">
                ...
                <input type="text" name="user_name" id="user_name" class="form-control" placeholder="Write your user name" value="{{ old('user_name') }}">
              ...
              <div class="form-group {{ $errors->has('phone') ? 'is-invalid' : '' }}">
                ...
                <input type="phone" name="phone" id="phone" class="form-control" placeholder="Phone Number" value="{{ old('phone') }}">
                <span class="text-danger">{{ $errors->has('phone') ? $errors->first('phone') : '' }}</span>
              </div>
              <div class="auto-generate " v-if="!auto_password">
              ...
              <div class="demo-checkbox">
                <input type="checkbox" id="md_checkbox_1" class="chk-col-red" name="auto_password" v-model="auto_password" />
                <label for="md_checkbox_1">
                      <span v-if="auto_password">Manualy Give Password</span>
                      <span v-if="!auto_password">Auto Generate Password</span>
                    </label>
              </div>
              <div class="form-group">
            ...
            <div class="body  {{ $errors->has('roles') ? 'border-role' : '' }}">
              ...
              <div id="checkbox" class="check_all">
                ...
                <div class="demo-checkbox mt-4">
                  <input type="checkbox" id="{{ $data->id }}" class="filled-in chk-col-red" name="roles[]" value="{{ $data->id }}" />
